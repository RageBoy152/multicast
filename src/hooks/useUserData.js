...
export const forcedNotif = {
  ...
  "title": "MultiCast V2.0.2 is live - Small bug fix",
  "body": `Read the release notes <a onclick="window.electronAPI.send('openExternal', 'https://github.com/RageBoy152/multicast/releases/tag/2.0.2')" class='text-text-shade hover:text-text cursor-pointer underline'>here</a>`,
  "status": "info",
  "toasted": true
}
